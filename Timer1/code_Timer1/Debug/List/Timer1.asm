...
; 0000 0013 DDRB.0 = 1;
	SBI  0x17,0
; 0000 0014 // chuong trinh con
; 0000 0015 lcd_init(16);
	LDI  R26,LOW(16)
	CALL _lcd_init
; 0000 0016 Timer1_Init();
	RCALL _Timer1_Init
; 0000 0017 #asm
...
_Timer1_Init:
; .FSTART _Timer1_Init
; 0000 0024   TCNT1 = 33536;
	LDI  R30,LOW(33536)
	LDI  R31,HIGH(33536)
	OUT  0x2C+1,R31
	OUT  0x2C,R30
; 0000 0025   TCCR1A = 0x00;
	OUT  0x2F,R30
; 0000 0026   TCCR1B |= (1<<CS10);
	IN   R30,0x2E
	ORI  R30,1
	OUT  0x2E,R30
; 0000 0027   TIMSK |= (1<<TOIE1);
	IN   R30,0x39
	ORI  R30,4
	OUT  0x39,R30
; 0000 0028 }
...
; .FSTART _tim1_ovf_isr
	ST   -Y,R30
	ST   -Y,R31
; 0000 002B   TCNT1 = 33536;
	LDI  R30,LOW(33536)
	LDI  R31,HIGH(33536)
	OUT  0x2C+1,R31
	OUT  0x2C,R30
; 0000 002C   PORTB.0 = !PORTB.0;
	SBIS 0x18,0
	RJMP _0xA
	CBI  0x18,0
	RJMP _0xB
