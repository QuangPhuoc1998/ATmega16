...
//GLCD control pins
#define GLCD_E	 		2// Enable line
#define GLCD_RW 		1 // read/write selecting line
#define GLCD_RS 		0 // Register select: Data/Instruction (DI)
#define GLCD_CS1        3 // left/right selecting line#1
...
uint8_t GLCD_ReadDATA(void){
	...
	_delay_us(10);			//[new]	cho du lieu tu GLCD RAM duoc day ra thanh ghi output		
...
void GLCD_PutBMP(const char *bmp){
	uint8_t Line, Col;
	uint16_t i;
	for (Line=0; Line<8; Line++){
		GLCD_GotoXY(Line,0);		
