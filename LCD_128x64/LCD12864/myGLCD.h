...
Log:
	Version:	v2
	Date:		2011-Sep-25
	New:		Sua ham GLCD_ReadDATA doc 2 lan, them 4 ham ve va xoa diem va duong thang (lien net)
*/
...
#define GLCD_DATA_O  	PORTB  // Ouput Data bus
#define GLCD_DATA_I	  	PINB   // Input Data bus
#define GLCD_DATA_DDR  	DDRB   // Direction

//define the control port (RS, RW, E, CS1, CS2)
#define GLCD_CTRL_O		PORTD 
#define GLCD_CTRL_I 	PIND 
#define GLCD_CTRL_DDR 	DDRD
//GLCD control pins
#define GLCD_E	 		5// Enable line
#define GLCD_RW 		6 // read/write selecting line
#define GLCD_RS 		7 // Register select: Data/Instruction (DI)
#define GLCD_CS1        4 // left/right selecting line#1
#define GLCD_CS2        3 // left/right selecting line#2
...
void GLCD_Delay(void){
	for(uint8_t i=0; i<5; i++) _delay_us(1);						
}						 					 					 		 
