...
_0x0:
	.DB  0x47,0x69,0x61,0x20,0x74,0x72,0x69,0x3A
	.DB  0x20,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 002F   over_step += 0xFFFF;
	LDS  R30,_over_step
	LDS  R31,_over_step+1
	LDS  R22,_over_step+2
	LDS  R23,_over_step+3
	__ADDD1N 65535
	STS  _over_step,R30
	STS  _over_step+1,R31
	STS  _over_step+2,R22
	STS  _over_step+3,R23
; 0000 0030 }
	LD   R30,Y+
	OUT  SREG,R30
	LD   R31,Y+
...
; 0000 0033   period = over_step + ((long int)ICR1H*256+ICR1L);
	...
	CALL __ADDD12
	LDS  R26,_over_step
	LDS  R27,_over_step+1
	LDS  R24,_over_step+2
	LDS  R25,_over_step+3
	CALL __ADDD12
	STS  _period,R30
	STS  _period+1,R31
	STS  _period+2,R22
